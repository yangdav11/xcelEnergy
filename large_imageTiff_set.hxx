...
class LargeImage : public ImageInterface {
    private:
        ...
        //stores the mosaic id, owner_id, filename, height, width, channels
        //will be used to extract the necessary information
        vector<vector<String> > imageInput;

        //stores the mosaic_id, x1, x2, y1, y2
        //will be used to extract the necessary information
        vector<vector<String> > lineInput;

        //will store a list of owner_ids to be used as
    ...
    public:
        ...
        LargeImage(vector< vector<String> > &_inputImage, vector< vector<String> > &_inputLines, int _padding, int _classification);
